...
// TODOx (1) Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// TODOx (2) Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// TODOx (3) Add a TextView with an id value of @id/tv_display
// TODOx (4) Set the text to something that indicates this is default text being displayed
// TODOx (5) Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// TODOx (6) Create a TextView field to display your message
// TODOx (7) Get a reference to your TextView in Java