...
public class MainActivity extends AppCompatActivity {
    ...
    // TODOx (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODOx (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
    ...
    // TODOx (2) Override onSaveInstanceState

    @Override
    protected void onSaveInstanceState(Bundle outState) {
        // Do steps 3 - 5 within onSaveInstanceState
        // TODOx (3) Call super.onSaveInstanceState
        super.onSaveInstanceState(outState);

        // TODOx (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
        logAndAppend(ON_SAVE_INSTANCE_STATE);
        // TODOx (5) Put the text from the TextView in the outState bundle
