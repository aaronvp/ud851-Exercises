...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // TODOx (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
        String takealot = "http://www.takealot.com";

        // TODOx (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
        openWebPage(takealot);
    ...
    // TODOx (1) Create a method called openWebPage that accepts a String as a parameter
    private void openWebPage(String url) {
        // TODOx (2) Use Uri.parse to parse the String into a Uri
        Uri webPage = Uri.parse(url);

        // TODOx (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
