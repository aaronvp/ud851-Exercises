...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // TODOx (5) Specify a String you'd like to share
        String butts = "I like big butts & I cannot lie";
    ...
    // TODOx (1) Create a void method called shareText that accepts a String as a parameter

    private void shareText(String ourText) {
        // Do steps 2 - 4 within the shareText method

        // TODOx (2) Create a String variable called mimeType and set it to "text/plain"
        String mimeType = "text/plain";

        // TODOx (3) Create a title for the chooser window that will pop up
        String title = "Rosso";
